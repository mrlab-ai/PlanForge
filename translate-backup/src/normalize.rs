...
use crate::build_model as bm;
use crate::normalization_function_admin::{NormalizationFunctionAdministrator, NumericAxiom};
use crate::pddl::{Condition, Domain, Problem};
use crate::pddl_parser::SExpr;
    ...
    pub fn add_global_constraints(&mut self) {
        ...
        for ax in &mut self.axioms {
            if ax.is_global_constraint {
                ...
                let forall =
                    Condition::Forall(ax.parameters.clone(), Box::new(ax.condition.clone()));
