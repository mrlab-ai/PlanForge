...
use planforge_sas::numeric::axioms::CalOperator;
...
type SignatureMap = HashMap<
    u64,
    Vec<u32>,
    std::hash::BuildHasherDefault<planforge_sas::numeric::state_registry::IdentityU64Hasher>,
>;
...
fn compute_hash_effects_with_preconditions(
    ...
    let mut effects_by_var: Vec<Vec<&planforge_sas::numeric::numeric_task::AssignmentEffect>> =
