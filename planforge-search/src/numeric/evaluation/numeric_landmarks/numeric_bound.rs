...
use planforge_sas::numeric::numeric_task::{AbstractNumericTask, AssignmentOperation};
use planforge_sas::numeric::utils::linear_effects::LinearExpression;
...
impl NumericBound {
    ...
    fn assignment_expression(
        &self,
        linearized_effect: &planforge_sas::numeric::utils::linear_effects::LinearNumericEffect,
        lhs: usize,
    ) -> LinearExpression {
    ...
    fn is_simple_effect(
        &self,
        assignment_effect: &planforge_sas::numeric::numeric_task::AssignmentEffect,
