    ...
    let result = match &cli.search {
        ...
        | planforge_searcher::SearchSpec::Gbfs(heuristic) => {
            ...
            let heuristic_override = match heuristic {
                ...
                planforge_searcher::HeuristicSpec::DomainAbstraction(domain_config) => {
                ...
                planforge_searcher::HeuristicSpec::CanonicalNumericPdb(config) => Some(Box::new(
                    ...
                    as Box<dyn planforge_search::numeric::evaluation::Heuristic + '_>),
                planforge_searcher::HeuristicSpec::GreedyNumericPdb(config) => Some(Box::new(
                    ...
                    as Box<dyn planforge_search::numeric::evaluation::Heuristic + '_>),
                planforge_searcher::HeuristicSpec::Lmcutnumeric(config) => Some(Box::new(
                    ...
                    as Box<dyn planforge_search::numeric::evaluation::Heuristic + '_>),
                planforge_searcher::HeuristicSpec::MultiDomainAbstractions(config) => {
                ...
                planforge_searcher::HeuristicSpec::ScpOnline(config) => {
                ...
                planforge_searcher::HeuristicSpec::FillScp(config) => {
