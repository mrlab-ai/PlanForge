...
use crate::preprocess_port::causal_graph::{CausalGraph, G_DO_NOT_PRUNE_VARIABLES};
use crate::preprocess_port::domain_transition_graph::{
...
use crate::preprocess_port::state::State;
...
pub fn run_preprocess(args: &[String]) {
    ...
    if crate::preprocess_port::helper_functions::DEBUG {
        println!(
