...
impl InvariantPart {
    ...
    pub fn get_assignment(
        &self,
        parameters: &[String],
        literal: &crate::translate::pddl_ast::Condition,
    ...
    pub fn possible_matches(
        &self,
        _own_literal: &crate::translate::pddl_ast::Condition,
        _other_literal: &crate::translate::pddl_ast::Condition,
    ) -> Vec<InvariantPart> {
        Vec::new()
    }
    ...
    pub fn matches(
        &self,
        other: &InvariantPart,
        own_literal: &crate::translate::pddl_ast::Condition,
        other_literal: &crate::translate::pddl_ast::Condition,
    ) -> bool {
...
impl Invariant {
    ...
    pub fn get_parameters_for_atom(
        &self,
        atom: &crate::translate::pddl_ast::Condition,
    ) -> Vec<String> {
...
pub fn get_literals(cond: &Condition) -> Vec<Condition> {
    match cond {
        ...
        Condition::And(v) => v
            .iter()
            .filter(|c| matches!(c, Condition::Atom(_, _)))
            .cloned()
            .collect(),
        _ => vec![],
    }
...
pub fn ensure_conjunction_sat(_system: &mut ConstraintSystem, parts: &[Vec<Condition>]) {
    ...
    for part in parts.iter().flatten() {
        match part {
            ...
            Condition::Atom(name, _args) => {
                pos.entry(name.clone()).or_default().push(part.clone());
            }
            _ => {}
        }
    }
...
pub fn ensure_inequality(
    system: &mut ConstraintSystem,
    lit1: &crate::translate::pddl_ast::Condition,
    lit2: &crate::translate::pddl_ast::Condition,
) {
